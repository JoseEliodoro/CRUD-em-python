...
class Aplication(Funcs):
    ...
    def screen_add(self):
        ...
        self.specie_entry = CTkEntry(self.window, placeholder_text='Espécie',  text_color=color_text_toplevel, fg_color=color_bg_entry_toplevel, border_color=color_border_entry_top,
                                        text_font='Arial 15')
        self.specie_entry.place(relx=0.05, rely=0.4, relwidth=0.9)


        self.order_entry = CTkEntry(self.window, placeholder_text='Order',  text_color=color_text_toplevel, fg_color=color_bg_entry_toplevel, border_color=color_border_entry_top,
                                        text_font='Arial 15')
        self.order_entry.place(relx=0.05, rely=0.5, relwidth=0.9)


        self.location_entry = CTkEntry(self.window, placeholder_text='Local da coleta', text_color=color_text_toplevel, fg_color=color_bg_entry_toplevel, border_color=color_border_entry_top,
                                        text_font='Arial 15')
    ...
    def screen_edit(self, id):
        ...
        self.specie_entry_edit = CTkEntry(self.window_edit, placeholder_text='Espécie',  text_color=color_text_toplevel, fg_color=color_bg_entry_toplevel, border_color=color_border_entry_top,
                                        text_font='Arial 15')
        self.specie_entry_edit.place(relx=0.05, rely=0.4, relwidth=0.9)


        self.order_entry_edit = CTkEntry(self.window_edit, placeholder_text='Order',  text_color=color_text_toplevel, fg_color=color_bg_entry_toplevel, border_color=color_border_entry_top,
                                        text_font='Arial 15')
        self.order_entry_edit.place(relx=0.05, rely=0.5, relwidth=0.9)


        self.location_entry_edit = CTkEntry(self.window_edit, placeholder_text='Local da coleta', text_color=color_text_toplevel, fg_color=color_bg_entry_toplevel, border_color=color_border_entry_top,
                                        text_font='Arial 15')
        ...
        self.btn_edit = CTkButton(self.window_edit, text='Editar', text_font='Arial 15', cursor='hand2', text_color=color_text_button_toplevel, fg_color=color_bg_button_toplevel,
                            border_color=color_border_button_toplevel, hover_color=color_hover_button_toplevel, command=lambda: self.alterar_cliente(dados[0]))
